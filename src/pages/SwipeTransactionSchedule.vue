      ...
      <div class="container">
        ...
        <template align="center">
          <el-table
            ...
            <el-table-column align="center" label="刷卡交易明细表" width="250">
              <el-table-column
                  align="center"
                  prop="xuhao"
                  label="序号"
  ...
  data() {
    return {
      ...
      exportDataStandard: {
        ...
        "交易前余额":  "jiaoyiqianjine",

        "交易金额": "jiaoyijine",
        "优惠金额": "youhuijine",
        "终端交易序号":  "zongduanjiaoyixulei",
        "终端编号":  "zongduanbianhao",
        "TAC":  "TAC",
      },
      exportName: "刷卡交易明细表",
      exportHeader: ["刷卡交易明细表"]
    };
  },
  methods: {
    createExportData() {
    ...
    dateFormat(picker) {
      ...
      this.axios.get('/SwipeTransactionSchedule/list',{
        params :{
